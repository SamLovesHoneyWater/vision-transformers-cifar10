...
class SPT(nn.Module):
    def __init__(self, *, dim, image_size, min_patch_size, channels = 3):
        super().__init__()
        self.patchers = []
        patch_dim = min_patch_size * min_patch_size * 5 * channels
        ...
        while patch_size >= min_patch_size:
            ...
            patcher = nn.Sequential(
                ...
                #nn.AdaptiveAvgPool2d(min_patch_size),
    ...
    def forward(self, x):
        ...
        for patch_size, patcher in self.patchers:
            patched.append(patcher(x_with_shifts))
...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        ...
        self.to_patch_embedding = SPT(dim=dim, image_size=image_size, min_patch_size=patch_size, channels=channels)
